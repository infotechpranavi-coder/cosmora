      ...
      <div className="py-20">
        <div className="max-w-4xl mx-auto px-4 lg:px-8 text-center">
          <div className="mb-8">
            ...
            {orderNumber && (
              <p className="text-[#2F3F8F] font-medium mt-3">Order #{orderNumber}</p>
            )}
          </div>
          ...
          <div className="space-y-4">
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/">
                <Button size="lg" className="bg-[#2F3F8F] hover:bg-[#1B2A4A]">
            ...
            <p className="text-sm text-gray-500">
              Need help? <Link href="/contact" className="text-[#2F3F8F] hover:underline">Contact our support team</Link>
            </p>
          </div>
          ...
          <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-8 text-left">
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              ...
              <div className="space-y-2 text-sm text-gray-600">
                ...
                <p>
                  <Link href="/return-policy" className="text-[#2F3F8F] underline">
