          ...
          <div className="grid lg:grid-cols-2 gap-12">
            <div className="bg-white rounded-2xl shadow-sm p-8 space-y-6">
              ...
              <div className="flex items-start gap-3 text-gray-700">
                <MapPin className="w-5 h-5 text-[#041428] mt-0.5" />
                <p>Plot No. A-12, TTC Industrial Area, MIDC Mahape, Navi Mumbai, Maharashtra 400710</p>
              </div>
              <div className="flex items-start gap-3 text-gray-700">
                <Phone className="w-5 h-5 text-[#041428] mt-0.5" />
                <p>Support +91 9619108909, +91 7506550101</p>
              </div>
              <div className="flex items-start gap-3 text-gray-700">
                <Mail className="w-5 h-5 text-[#041428] mt-0.5" />
                <p>Email: info@cosmora.in</p>
              </div>
              <div className="flex items-start gap-3 text-gray-700">
                <Clock className="w-5 h-5 text-[#041428] mt-0.5" />
                <div>
              ...
              <div className="flex items-start gap-3 text-gray-700">
                <Briefcase className="w-5 h-5 text-[#041428] mt-0.5" />
                <div>
