        ...
        <div className="max-w-7xl mx-auto px-4 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12">
            <div className="bg-white rounded-2xl shadow-sm p-8 space-y-6">
              <h2 className="text-2xl font-extrabold text-[#172033]">Our Address</h2>
              <div className="flex items-start gap-3 text-[#172033]">
                <MapPin className="w-5 h-5 text-[#14243D] mt-0.5" />
                <p>Plot No. A-12, TTC Industrial Area, MIDC Mahape, Navi Mumbai, Maharashtra 400710</p>
              </div>
              <div className="flex items-start gap-3 text-[#172033]">
                <Phone className="w-5 h-5 text-[#14243D] mt-0.5" />
                <p>Support +91 9619108909, +91 7506550101</p>
              </div>
              <div className="flex items-start gap-3 text-[#172033]">
                <Mail className="w-5 h-5 text-[#14243D] mt-0.5" />
                <p>Email: info@cosmora.in</p>
              </div>
              <div className="flex items-start gap-3 text-[#172033]">
                <Clock className="w-5 h-5 text-[#14243D] mt-0.5" />
                <div>
              ...
              <div className="flex items-start gap-3 text-[#172033]">
                <Briefcase className="w-5 h-5 text-[#14243D] mt-0.5" />
                <div>
            ...
            <div className="bg-white rounded-2xl shadow-sm p-8">
              <h2 className="text-2xl font-extrabold text-[#172033] mb-6">Leave us a Message</h2>
              <ContactForm />
            </div>
          </div>
        </div>
