  ...
  return (
    <Link href={href} className="group block min-w-0">
      <div className="relative bg-white rounded-3xl shadow-[0_12px_40px_rgba(0,0,0,0.08)] overflow-hidden aspect-[4/3] sm:aspect-[5/4] ring-1 ring-neutral-200/80 group-hover:ring-neutral-400/80 transition-all duration-500 group-hover:-translate-y-1 group-hover:shadow-[0_24px_50px_rgba(0,0,0,0.14)]">
        ...
        {priceLabel && (
          <div className="absolute bottom-3 right-3 bg-[#041428] text-white px-3 py-1.5 rounded-xl shadow-md text-right leading-tight">
      ...
      <h3 className="mt-3 text-center text-sm sm:text-base font-extrabold text-gray-900 uppercase tracking-wide line-clamp-2 group-hover:text-[#041428] transition-colors">
        {name}
      </h3>
    </Link>
  )
    ...
    <section className="py-8 sm:py-10">
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-10">
        <div className="flex items-center gap-3 mb-6">
          <span className="inline-block w-3.5 h-7 sm:w-4 sm:h-8 bg-[#A48450] rounded-[3px]" />
