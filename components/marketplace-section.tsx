  ...
  return (
    <Link href={href} className="group block min-w-0">
      <div className="relative bg-white rounded-3xl shadow-[0_12px_40px_rgba(0,0,0,0.08)] overflow-hidden aspect-[4/3] sm:aspect-[5/4] ring-1 ring-neutral-200/80 group-hover:ring-neutral-400/80 transition-all duration-500 group-hover:-translate-y-1 group-hover:shadow-[0_24px_50px_rgba(0,0,0,0.14)]">
        ...
        {priceLabel && (
          <div className="absolute bottom-3 right-3 bg-[#14243D] text-white px-3 py-1.5 rounded-xl shadow-md text-right leading-tight">
      ...
      <h3 className="mt-3 text-center text-sm sm:text-base font-extrabold text-[#172033] uppercase tracking-wide line-clamp-2 group-hover:text-[#14243D] transition-colors">
        {name}
      </h3>
    </Link>
  )
    ...
    <section className="py-8 sm:py-10">
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-10">
        <div className="flex items-center gap-3 mb-6">
          <span className="inline-block w-3.5 h-7 sm:w-4 sm:h-8 bg-[#C49A52] rounded-[3px]" />
          <h2 className="text-2xl sm:text-3xl font-extrabold text-[#172033] tracking-tight">{title}</h2>
        </div>
